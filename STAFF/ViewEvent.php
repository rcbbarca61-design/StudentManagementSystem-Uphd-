...
$a = "SELECT `event`.*,`staff`.* FROM `event`,`staff` WHERE `event`.`sid`=`staff`.`sid` AND `staff`.`sid`='$uid'";
...
<section class="contact-page-area section-gap">
    <div class="container">
        <div class="row">
            <h1 style="color: orangered; margin-left:450px;">View Event</h1><br><br><br>
                    ...
                    <tbody id="tableBody">
                        ...
                        ?>
                            <tr class="text-center" style="color: black;">
                                ...
                                <td><img src="../media/<?php echo $row['evimg']; ?>" alt="" style="height: 100px; width: 150px;"></td>
                                <td><?php echo date("d-m-Y H:i:s", strtotime($row['evdatetime'])); ?></td>
                                <td><?php echo $row['evdesc']; ?></td>
