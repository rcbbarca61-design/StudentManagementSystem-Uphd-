...
$a = "SELECT `feedback`.*, `staff`.* FROM `feedback`, `staff` WHERE `feedback`.`sid` = `staff`.`sid`";
$qry = mysqli_query($conn, $a);
if (mysqli_num_rows($qry) < 1) {
?>
    <center>
        <h1 style="color: black;">No Feedback Added</h1>
    </center>
<?php
} else {
?>
    ...
    <div class="container">                
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="#">View Feedbacks</a></p>
            </div>  
        </div>
    </div>
</section>
...
<section class="contact-page-area section-gap">
    <div class="container">
        <div class="row">
            <h2 class="text-center" style="color: orangered; margin-bottom: 30px;margin-left:450px;">Feedback List</h2>
                    ...
                    <tbody id="tableBody">
                        ...
                        ?>
                            <tr class="text-center" style="color: black;">
                                ...
                                <td><?php echo date("d-m-Y H:i:s", strtotime($row['fdate'])); ?></td>
                            </tr>
                        <?php
                        }
                        ?>
