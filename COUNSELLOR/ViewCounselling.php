...
$a = "SELECT `student`.`studid`,`fname`,`counsellor`.`co_name`,`co_id`,`chat_members`.* FROM `chat_members`,`student`,`counsellor` WHERE `counsellor`.`co_id`=`chat_members`.`c_id` AND `student`.`studid`=`chat_members`.`studid` AND `counsellor`.`co_id`='$uid'";
                        ...
                        ?>
                            <tr class="text-center" style="color: black;">
                                ...
                                <td><div class="d-flex justify-content-center align-items-center">
                                        <a href="CounsellorChat.php?id=<?php echo $row['chat_mid'] ?>&student_id=<?php echo $s_id; ?>" class="btn btn-outline-danger ml-2">Chat</a>
                                    </div></td>
                            </tr>
                        <?php
                        }
